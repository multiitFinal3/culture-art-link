"CREATE TABLE `exhibition_analyze` (
  ...
  PRIMARY KEY (`id`),
  KEY `exhibition_analyze_ibfk_1` (`exhibition_id`),
  KEY `exhibition_analyze_ibfk_2` (`user_id`),
  CONSTRAINT `exhibition_analyze_ibfk_1` FOREIGN KEY (`exhibition_id`) REFERENCES `exhibition` (`id`) ON DELETE CASCADE,
  CONSTRAINT `exhibition_analyze_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
);"
"CREATE TABLE `exhibition_comment` (
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `exhibition_comment_ibfk_2` (`user_id`),
  KEY `exhibition_comment_ibfk_1` (`exhibition_id`),
  CONSTRAINT `exhibition_comment_ibfk_1` FOREIGN KEY (`exhibition_id`) REFERENCES `exhibition` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `exhibition_comment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
);"
