...
public class SpringSecurityConfiguration {
	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.authorizeHttpRequests((auth) -> auth
				...
				.requestMatchers("/","/home","/user/login/**","/user/logout/**","/user/signUp/**","/user/login2/**","/festival/findPopularFestivalKeyword","/exhibition/exhibition/keyword","/admin/festival-regulate/findAllRegionAndTime","/main/**","/festival/findSameRegionFestivalByRegionId","/admin/cultural-properties-regulate/keywords","/admin/cultural-properties-regulate/keywords/select","/admin/cultural-properties-regulate/categories").permitAll()
