...
public class AdminCulturalPropertiesService{
    ...
    @Autowired
    public AdminCulturalPropertiesService(AdminCulturalPropertiesDAO adminCulturalPropertiesDAO){ this.adminCulturalPropertiesDAO = adminCulturalPropertiesDAO; }
